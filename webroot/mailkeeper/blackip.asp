<%
	...
	if(((VSUBMIT = "Submit") or (VADMIN = "Y")) and (VIP <> ""))then
		...
		if(VCMD = "RELEASE")then
			VTO          = EMAILTO 
			VSUBJECT     = "[C] RELEASEBLACKIP " & VIP 
			VBODY        = "admin: " & VADMIN & " " & request("EMAIL") & vbcrlf
			...
			VMESSAGE = "Thank you! We'll release the IP address " & VIP & " soon."
...
<LINK REL="SHORTCUT ICON" HREF="http://webmail.cbcm.org/home_page_pictures/favicon.ico">
      ...
      <table border="0" cellspacing="0" cellpadding="5" width="606">
        <tr valign="top"> 
          <td height="41" width="383"> 
            <p><font face="Arial, Helvetica, sans-serif" size="4"><b><i><font color="#000000">Release Blocked IP Address<img src="/home_page_pictures/line.gif" width="392" height="6"></font></i></b></font></p>
          </td>
...
<%	else %>
			<tr>
				<td width="100%">
					<form action="blackip.asp" method="post" name="blackip" id="blackip">
					  <table width="100%" border="1">
						<tr> 
						  <td width="47%"><font size="3" face="Arial, Helvetica, sans-serif">IP</font></td>
						  <td width="53%"><font face="Arial, Helvetica, sans-serif"> 
							<input name="IP" type="text" id="IP" size="32" maxlength="50" value="<%=VIP%>">
							</font></td>
						</tr>
						<tr> 
...
<%	end if %>		   
			<tr valign="top">
			  <td height="2" colspan="4"><font face="Arial, Helvetica, sans-serif" size="1">If you sent us an email but your email was rejected, it was because your email address or IP address was not on our &quot;white list.&quot; Please send an email to <a href="mailto:whitelist@cbcm.org?subject=Put%20Me%20into%20Church%27s%20White%20List">whitelist@cbcm.org</a>, and we will include your email address on our white list. Then you can send the email again, and it will get through this time. Thank you for your cooperation!</font></td>
			</tr>
      </table>
